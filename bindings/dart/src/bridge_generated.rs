...
fn wire_register_token_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String, _>(
        ...
        move || {
            ...
            move |task_callback| Result::<_, ()>::Ok(register_token(api_id, api_token))
        },
    )
}
fn wire_forward_message_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String, _>(
        ...
        move || {
            ...
            move |task_callback| Result::<_, ()>::Ok(forward_message(api_receiver_id, api_data))
        },
    )
}
fn wire_query_by_sn_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String, _>(
        ...
        move || {
            ...
            move |task_callback| Result::<_, ()>::Ok(query_by_sn(api_receiver_id, api_sn))
        },
    )
}
fn wire_query_by_digest_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String, _>(
        ...
        move || {
            ...
            move |task_callback| Result::<_, ()>::Ok(query_by_digest(api_receiver_id, api_digests))
        },
    )
}
